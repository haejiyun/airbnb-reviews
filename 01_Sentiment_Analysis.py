...
with SentimentTab: ################################################# Sentiment Analysis
    ...
    with col1: #On the first column
        ...
        choropleth.update_traces(marker_line_width=0, #Update market configuration
                                 marker_opacity=0.8)
        choropleth.update_layout(coloraxis_colorbar={'lenmode': 'pixels','len': 325,'yanchor':'bottom','y': 0}, #Update colorbar configuration
    ...
    with col2: #On the second column
        ...
        ax2 = wordcloud.add_axes([0, 0, 1, 1]) #Configure wordcloud position for negative comments
