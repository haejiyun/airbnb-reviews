...
st.write("") #Blank line
st.subheader("Language Detection") #Subheader
st.write('''
...
st.write("") #Blank line
st.subheader("Translation") #Subheader
st.write('''
...
st.write("") #Blank line
st.subheader("Sentiment Score") #Subheader
st.write('''
...
st.write("") #Blank line
st.subheader("Multi-Label Classification") #Subheader
st.write('''
